...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#020617] relative overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-cyan-500/10 rounded-full blur-[120px] -mr-48 -mt-48 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-[120px] -ml-48 -mb-48 pointer-events-none"></div>

      <div className="w-full max-w-md glass-card p-10 rounded-[2.5rem] border-white/5 relative z-10 shadow-2xl">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-balck bg-clip-text text-transparent bg-gradient-to-r from-white to-cyan-400 uppercase tracking-tighter mb-2">Вход</h1>
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="pt-6 text-center space-y-4">
            <p className="text-[10px] font-bold text-white/30 uppercase tracking-widest">
              Нет аккаунта?{" "}
              <a className="text-cyan-400 hover:text-white transition-colors" href="/register">
                Создать профиль
              </a>
            </p>
            <a
